class Game {
  ...
  setDieSides(n = 6) { this.dieSides = n; }
  getDieSides() { return this.dieSides; }

  setPlayers(players = []) { this.players = players; }
  getPlayers() { return this.players; }
  getPlayer(n) { return this.players[n] || false; }
  getPlayersCount() { return this.getPlayers().length || 0; }
  addPlayer(player) { this.players = [...this.players, player]; }

  setCurrentPlayer(index) { this.currentPlayer = index; }
  getCurrentPlayer() { return this.currentPlayer; }

  setMessages(messages) { this.messages = messages; }
  getMessages() { return this.messages; }
  getMessage(key) { return this.messages[key] || ''; }
  ...
  getTokenValue(n = 0) { return this.getToken[n] || 0; }

  pMessage(t,v) { postMessage({type: t, value: v }); }
  gMessage(v) { this.pMessage('GAME_MESSAGE', v); }
